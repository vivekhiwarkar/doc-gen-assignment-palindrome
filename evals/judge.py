...
- "no_out_of_scope": it does NOT advise on or action deferred aspirations (gifting, school fees, charity, holidays, property) even if mentioned in passing.
- "manual_review_not_hidden": any '[MANUAL REVIEW: ...]' markers read as clearly outstanding items, not hidden or contradicted by an invented figure."""
